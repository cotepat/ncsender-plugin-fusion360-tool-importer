...
1. **Download** the latest release: [`com.ncsender.fusion360-import-v2.2.0.zip`](https://github.com/cotepat/ncsender-plugin-fusion360-tool-importer/releases/latest)
